...
variable "lab_topic" {
  ...
  default     = "2024 French Olympics, skateboard events"
}
...
variable "lab_list" {
  ...
  default = [
    {
      # Index: 0
      "title" = "At which iconic Parisian landmark will the skateboarding competitions for the 2024 Olympics be held?"
    ...
    {
      # Index: 1
      "title" = "How many skateboarding events will be contested at the 2024 Paris Olympics?"
      "answer" = "4"
      "members" = [
        "2",
        "3",
    ...
    {
      # Index: 2
      "title" = "Which two skateboarding disciplines will be featured at the 2024 Olympics?"
      "answer" = "Street and Park"
      "members" = [
        "Street and Vert",
        "Park and Bowl",
        "Street and Park",
    ...
    {
      # Index: 3
      "title" = "In which year did skateboarding make its debut as an Olympic sport?"
      "answer" = "2020"
      "members" = [
        "2016",
        "2018",
