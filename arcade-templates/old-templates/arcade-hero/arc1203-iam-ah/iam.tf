...
#    { step = "Select the '${var.gcp_iam_role_1}' role.", "command": "TBC" },
    { step = "Search for '${var.gcp_user_1}' or navigate through the role hierarchy to find it.  It's usually located under 'Cloud Storage'.", "command": "TBC" },
    { step = "Select the '${var.gcp_user_1}' role.", "command": "TBC" },
