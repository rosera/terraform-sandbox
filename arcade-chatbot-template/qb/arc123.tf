...
variable "lab_list" {
  ...
  default = [
    {
      # Index: 0
      "title" = "What is the name of the iconic landmark that was once a symbol of division and is now a symbol of unity in Berlin?"
    ...
    {
      # Index: 1
      "title" = "Which major river flows through Berlin?"
      "answer" = "Spree"
      "members" = [
        "Rhine",
        "Danube",
