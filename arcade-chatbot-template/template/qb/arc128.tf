...
variable "lab_list" {
  ...
  default = [
    {
      # Index: 0
      "title" = "Which of the following is Frankfurt most famous for being?"
      "answer" = "A major financial center"
      "members" = [
    ...
    {
      # Index: 1
      "title" = "What is the name of Frankfurt's international airport, one of the busiest in Europe?"
